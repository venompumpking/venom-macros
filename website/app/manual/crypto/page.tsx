...
const KF = `
  ...
  @keyframes pmWarnPulse {
    0%, 100% { border-color: rgba(247,147,26,0.18); }
    50%      { border-color: rgba(247,147,26,0.38); }
  }
`;

const ease = "cubic-bezier(0.22,1,0.36,1)";

function ManualCryptoContent() {
  ...
  const steps = [
    ...
    `State your plan: ${plan} (${price})`,
    "Staff provides wallet address and accepted coins",
    "Send the exact USD amount in crypto",
    "License is linked once payment confirms on-chain",
  ];
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            height: 3,
            background: "linear-gradient(90deg, #f7931a, #e8a020, #fbbf24)",
          ...
          <div style={{ padding: "2.25rem 2rem" }}>
            ...
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              marginBottom: "1.5rem", fontSize: 24, fontWeight: 900, color: "#f7931a",
              animation: `pmFadeUp 0.55s ${ease} 220ms both, pmIconBob 3.8s ease-in-out 1.5s infinite`,
            }}>
              ₿
            </div>
            ...
            <p style={{
              fontSize: 14, color: "rgba(243,243,247,0.48)", lineHeight: 1.65, margin: "0 0 1.5rem",
              animation: `pmFadeUp 0.5s ${ease} 330ms both`,
            }}>
              Crypto is handled manually through Discord. Open a ticket and staff will provide wallet details for your {plan} plan.
            </p>
            ...
            <div style={{
              ...
              fontSize: 13, color: "rgba(243,243,247,0.55)",
              lineHeight: 1.55, marginBottom: "1.75rem",
              animation: `pmFadeUp 0.5s ${ease} 370ms both, pmWarnPulse 3.5s ease-in-out 1.8s infinite`,
            }}>
              <strong style={{ color: "rgba(247,147,26,0.8)" }}>Note:</strong> Supported coins are confirmed by staff in Discord.
              Include your Discord tag and plan ({plan} — {price}) in your ticket.
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: "1.75rem" }}>
              {steps.map((text, i) => (
                <div key={i} style={{
                  ...
                  animation: `pmStepIn 0.5s ${ease} ${420 + i * 75}ms both`,
                }}>
                  <div style={{
            ...
            <a
              ...
              style={{
                ...
                animation: `pmFadeUp 0.55s ${ease} ${420 + steps.length * 75}ms both`,
              }}
              onMouseEnter={e => {
...
export default function ManualCrypto() {
  return (
